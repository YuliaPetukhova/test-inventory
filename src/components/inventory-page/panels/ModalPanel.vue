...
<template>
  <div class="panel">
    ...
    <div>
      <button type="button" class="modal-button-delete">Удалить предмет</button>
    </div>
...
.modal-button-cancel:hover {
  box-shadow: 0 0 17px rgba(250, 114, 114, 0.7);
}
...
.ghost-element {
  ...
  animation: loading 1.5s infinite alternate; /* Анимация */
  border-radius: 12px;
}
